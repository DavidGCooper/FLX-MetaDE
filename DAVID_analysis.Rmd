...
## KEGG pathway overlap GSEA vs DAVID

```{r All TvU All Graphs}
GSEApvaluesDF=readRDS("MetaDE RDS/AllFTUgsea.rds")
GSEApvaluesDF$Pathway=gsub(" \\| KEGG","",GSEApvaluesDF$Pathway)

pvaluesDF=readRDS("MetaDE RDS/AllFTU_DAVID.rds")
pvaluesDF$Pathway=gsub("[0-9]{5}:","",rownames(pvaluesDF))

NewpvaluesDF=merge(GSEApvaluesDF[,55:61],pvaluesDF[,55:60],by = "Pathway",all = FALSE,
                   suffixes = c(".GSEA",".DAVID"))

ggplot(NewpvaluesDF,aes(-log10(Fish.GSEA),-log10(Fish.DAVID),label=Pathway))+
  geom_point(size=4)+
  xlab("-log10(q) | GSEA")+
  ylab("-log10(q) | DAVID")+
  theme_classic()+
  geom_text_repel(data = filter(NewpvaluesDF,Fish.GSEA<1E-50|Fish.DAVID<1E-20),max.overlaps = 20,size=4,box.padding   = 0.5, point.padding = 0.5)+
  theme(axis.text = element_text(size=12),axis.title = element_text(size = 12))
ggsave("Figures/AllFTUgsea-DAVID.tiff",height = 5,width = 6)

ggplot(NewpvaluesDF,aes(-log10(Max.GSEA),-log10(Max.DAVID)))+
  geom_point()

```

```{r Stress TvU All Graphs}
GSEApvaluesDF=readRDS("MetaDE RDS/AllSFTUgsea.rds")
GSEApvaluesDF$Pathway=gsub(" \\| KEGG","",GSEApvaluesDF$Pathway)

pvaluesDF=readRDS("MetaDE RDS/AllSFTU_DAVID.rds")
pvaluesDF$Pathway=gsub("[0-9]{5}:","",rownames(pvaluesDF))

NewpvaluesDF=merge(GSEApvaluesDF[,14:19],pvaluesDF[,14:18],by = "Pathway",all = FALSE,
                   suffixes = c(".GSEA",".DAVID"))
...
ggplot(NewpvaluesDF,aes(-log10(Fish.GSEA),-log10(Fish.DAVID),label=Pathway))+
  ...
  ylab("-log10(q) | DAVID")+
  theme_classic()+
  geom_text_repel(data = filter(NewpvaluesDF,Fish.GSEA<1E-30|Fish.DAVID<1E-20),max.overlaps = 20,size=4,box.padding   = 0.5, point.padding = 0.5)+
  theme(axis.text = element_text(size=12),axis.title = element_text(size = 12))
ggsave("Figures/AllSFTUgsea-DAVID.tiff",height = 5,width = 6)
...
```{r No stress TvU All Graphs}
GSEApvaluesDF=readRDS("MetaDE RDS/AllXFTUgsea.rds")
GSEApvaluesDF$Pathway=gsub(" \\| KEGG","",GSEApvaluesDF$Pathway)

pvaluesDF=readRDS("MetaDE RDS/AllXFTU_DAVID.rds")
pvaluesDF$Pathway=gsub("[0-9]{5}:","",rownames(pvaluesDF))

NewpvaluesDF=merge(GSEApvaluesDF[,42:48],pvaluesDF[,42:47],by = "Pathway",all = FALSE,
                   suffixes = c(".GSEA",".DAVID"))
...
ggplot(NewpvaluesDF,aes(-log10(Fish.GSEA),-log10(Fish.DAVID),label=Pathway))+
  ...
  ylab("-log10(q) | DAVID")+
  theme_classic()+
  geom_text_repel(data = filter(NewpvaluesDF,Fish.GSEA<1E-40|Fish.DAVID<1E-20),max.overlaps = 20,size=4,box.padding   = 0.5, point.padding = 0.5)+
  theme(axis.text = element_text(size=12),axis.title = element_text(size = 12))
ggsave("Figures/AllXFTUgsea-DAVID.tiff",height = 5,width = 6)
...
```{r All RvN All Graphs}
GSEApvaluesDF=readRDS("MetaDE RDS/AllSFRNgsea.rds")
GSEApvaluesDF$Pathway=gsub(" \\| KEGG","",GSEApvaluesDF$Pathway)

pvaluesDF=readRDS("MetaDE RDS/AllRvN_DAVID.rds")
pvaluesDF$Pathway=gsub("[0-9]{5}:","",rownames(pvaluesDF))

NewpvaluesDF=merge(GSEApvaluesDF[,10:15],pvaluesDF[,10:14],by = "Pathway",all = FALSE,
                   suffixes = c(".GSEA",".DAVID"))


ggplot(NewpvaluesDF,aes(-log10(Fish.GSEA),-log10(Fish.DAVID)))+
  geom_point()
