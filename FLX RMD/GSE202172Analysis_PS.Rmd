...
countmatrix <- Reduce(function(...) merge(..., all = TRUE, by = "V1"),
       countdata)
...
inputcounts <- countmatrix[, c("GH_Veh_INPUT1", "GH_Veh_INPUT2", "SH_Veh_INPUT1", "SH_Veh_INPUT2",
                               "Flx_INPUT1", "Flx_INPUT2","A_Flx_INPUT1", "A_Flx_INPUT2",
                               "GH_Veh_INPUT3", "GH_Veh_INPUT4", "SH_Veh_INPUT3", "SH_Veh_INPUT4",
                               "Flx_INPUT3","Flx_INPUT4", "A_Flx_INPUT3",  "A_Flx_INPUT4")]
TRAPcounts <- countmatrix[, c("GH_Veh_TRAP1", "GH_Veh_TRAP2", "SH_Veh_TRAP1", "SH_Veh_TRAP2",
                              "Flx_TRAP1", "Flx_TRAP2", "A_Flx_TRAP1", "A_Flx_TRAP2",
                              "GH_Veh_TRAP3", "GH_Veh_TRAP4", "SH_Veh_TRAP3", "SH_Veh_TRAP4",
                              "Flx_TRAP3", "Flx_TRAP4", "A_Flx_TRAP3", "A_Flx_TRAP4")]

#If the count table has to be created, save it as an .rds file to easily load in later
...
EnhancedVolcano(INPUT.GH_Veh.vs.SH_Veh, lab = rownames(INPUT.GH_Veh.vs.SH_Veh), x = 'log2FoldChange', y = 'pvalue', 
                title = "INPUT.GH_Veh.vs.SH_Veh")
...
EnhancedVolcano(TRAP.GH_Veh.vs.SH_Veh, lab = rownames(TRAP.GH_Veh.vs.SH_Veh), x = 'log2FoldChange', y = 'pvalue',
                title = "TRAP.GH_Veh.vs.SH_Veh")
...
INPUT.SH_Veh.vs.GH_Veh=readRDS("../FLX_datasets/GSE202172/DESeqINPUT.SH_Veh.vs.GH_Veh_GSE202172.rds")
INPUT.Flx_Sh.vs.SH_Veh=readRDS("../FLX_datasets/GSE202172/DESeqINPUT.Flx_Sh.vs.SH_Veh_GSE202172.rds")
INPUT.Flx_Anx.vs.SH_Veh=readRDS("../FLX_datasets/GSE202172/DESeqINPUT.Flx_Anx.vs.SH_Veh_GSE202172.rds")
INPUT.Flx_Norm.vs.Flx_Anx=readRDS("../FLX_datasets/GSE202172/DESeqINPUT.Flx_Norm.vs.Flx_Anx_GSE202172.rds")
INPUT.Flx.vs.Veh=readRDS("../FLX_datasets/GSE202172/DESeqINPUT.Flx.vs.Veh_GSE202172.rds")
TRAP.SH_Veh.vs.GH_Veh=readRDS("../FLX_datasets/GSE202172/DESeqTRAP.SH_Veh.vs.GH_Veh_GSE202172.rds")
TRAP.Flx_Sh.vs.SH_Veh=readRDS("../FLX_datasets/GSE202172/DESeqTRAP.Flx_Sh.vs.SH_Veh_GSE202172.rds")
TRAP.Flx_Anx.vs.SH_Veh=readRDS("../FLX_datasets/GSE202172/DESeqTRAP.Flx_Anx.vs.SH_Veh_GSE202172.rds")
TRAP.Flx_Norm.vs.Flx_Anx=readRDS("../FLX_datasets/GSE202172/DESeqTRAP.Flx_Norm.vs.Flx_Anx_GSE202172.rds")
TRAP.Flx.vs.Veh=readRDS("../FLX_datasets/GSE202172/DESeqTRAP.Flx.vs.Veh_GSE202172.rds")
...
plotEnrichment(pathwayDB[["Ribosome - Mus musculus (mouse) | KEGG"]], 
               IN.Gh.Sh.Stat) + labs(title = "Ribosome - Mus musculus (mouse) | KEGG")

plotEnrichment(pathwayDB[["glycolysis I | MouseCyc"]], 
               IN.Flx.Veh.Stat) + labs(title = "glycolysis I | MouseCyc")

plotEnrichment(pathwayDB[["Spliceosome - Mus musculus (mouse) | KEGG"]], 
               IN.Flx.Anx.Stat) + labs(title = "Spliceosome - Mus musculus (mouse) | KEGG")

plotEnrichment(pathwayDB[["Translation | Reactome"]], 
               TRP.Gh.Sh.Stat) + labs(title = "Translation | Reactome")

plotEnrichment(pathwayDB[[
  "The citric acid (TCA) cycle and respiratory electron transport | Reactome"]],
  TRP.Flx.Veh.Stat)+labs(title = "The citric acid (TCA) cycle and respiratory electron transport | 
                        Reactome")

plotEnrichment(pathwayDB[["Neuronal System | Reactome"]], 
               TRP.Flx.Anx.Stat) + labs(title = "Neuronal System | Reactome")
...
IN.Gh.Sh.select <- INPUT.GH_Veh.vs.SH_Veh.df$GeneID %in% pathwayDB[["Ribosome - Mus musculus (mouse) | KEGG"]]
...
TRP.Gh.Sh.select <- TRAP.GH_Veh.vs.SH_Veh.df$GeneID %in% pathwayDB[["Translation | Reactome"]]
