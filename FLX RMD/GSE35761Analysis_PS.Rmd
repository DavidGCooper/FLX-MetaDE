...
saveRDS(GeneEnrich,"../FLX_datasets/GSE35761/GSEA_GSE35761.rds")

write.table(t(plyr::ldply(DElist,rbind)),"../FLX_datasets/GSE35761/GSE35761-DElist.txt",sep = "\t",na = "",quote = FALSE,col.names = FALSE,row.names = FALSE)
write.table(DEbackground,"../FLX_datasets/GSE35761/GSE35761-DEbackground.txt",quote = FALSE,col.names = FALSE,row.names = FALSE)
