...
#table(decideTests(lm_fit43_reponse_VDG))
...
#DE files
lm_fit43_pooled_VDG=readRDS("../FLX_datasets/GSE43261/DE_PooledVDG_GSE43261.rds")
lm_fit43_pooled_DDG=readRDS("../FLX_datasets/GSE43261/DE_PooledDDG_GSE43261.rds")
lm_fit43_reponse_VDG=readRDS("../FLX_datasets/GSE43261/DE_ResponseVDG_GSE43261.rds")
lm_fit43_reponse_DDG=readRDS("../FLX_datasets/GSE43261/DE_ResponseDDG_GSE43261.rds")
...
fgseaPooled_VDG <- fgsea(pathways, PooledStat_VDG, minSize=10)
...
fgseaRespond_VDG <- fgsea(pathways, RespondStat_VDG, minSize=10)
...
fgseaResistant_VDG <- fgsea(pathways, ResistantStat_VDG, minSize=10)
...
fgseaResVRes_VDG <- fgsea(pathways, ResVResStat_VDG, minSize=10)
...
fgseaPooled_DDG <- fgsea(pathways, PooledStat_DDG, minSize=10)
...
fgseaRespond_DDG <- fgsea(pathways, RespondStat_DDG, minSize=10)
...
fgseaResistant_DDG <- fgsea(pathways, ResistantStat_DDG, minSize=10)
...
fgseaResVRes_DDG <- fgsea(pathways, ResVResStat_DDG, minSize=10)
