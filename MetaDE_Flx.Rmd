...
## Significant Genes/Pathways Bar Graph
...
```{r Scatter Plot}
ggplot(diff_Combined_merge,aes(samples,counts,color=StressOrganism,label=comparison))+
  geom_point(size=5)+
...
ggplot(diff_Combined_merge[diff_Combined_merge$TorR=="RN",],aes(samples,counts,color=StressOrganism,label=comparison))+
  geom_point(size=5)+
  #scale_y_continuous(transform = "log10")+
  xlab("Samples per Group")+
  ylab("Number of Significant Genes")+
...
ggplot(diff_Combined_merge[diff_Combined_merge$TorR=="TU",],aes(samples,counts,color=StressOrganism,label=comparison))+
  geom_point(size=5)+
  #scale_y_continuous(transform = "log10")+
  xlab("Samples per Group")+
  ylab("Number of Significant Genes")+
...
ggplot(GSEA_Combined_merge,aes(samples,counts,color=StressOrganism,label=comparison))+
  geom_point(size=5)+
  #scale_y_continuous(transform = "log10")+
  xlab("Samples per Group")+
...
ggplot(GSEA_Combined_merge[GSEA_Combined_merge$TorR=="RN",],aes(samples,counts,color=StressOrganism,label=comparison))+
  geom_point(size=5)+
  #scale_y_continuous(transform = "log10")+
  xlab("Samples per Group")+
  ylab("Number of Significant Pathways")+  
...
ggplot(GSEA_Combined_merge[GSEA_Combined_merge$TorR=="TU",],aes(samples,counts,color=StressOrganism,label=comparison))+
  geom_point(size=5)+
  #scale_y_continuous(transform = "log10")+
  xlab("Samples per Group")+
  ylab("Number of Significant Pathways")+  
