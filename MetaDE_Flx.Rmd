...
#Organism grouped data to filter into subsets
#Human
HumanGSEADataMerge=as.data.frame(readRDS("Input RDS/Human_Merged_GSEA_df.rds"))
...
#Human TvU
HumanDFTUgsea=HumanGSEADataMerge[,!grepl("GSE83386_Lympho_DFTUXX|GSE83386_Lympho_DFRNXX",colnames(HumanGSEADataMerge))]
...
#Mouse
MouseGSEADataMerge=as.data.frame(readRDS("Input RDS/Mouse_Merged_GSEA_df.rds"))
...
#Rat
RatGSEADataMerge=as.data.frame(readRDS("Input RDS/Rat_Merged_GSEA_df.rds"))
...
#All
AllGSEADataMerge=as.data.frame(readRDS("Input RDS/All_Merged_GSEA_df.rds"))
...
ggplot(pvaluesDF)+
  geom_density(aes(x=Vote,fill=Group),alpha=0.3,linewidth=0.8)+
  theme_classic()+
  scale_x_continuous(breaks=seq(-30,15,5))+ #breaks=seq(-X,X,X)
  scale_y_continuous(expand = c(0, 0), limits = c(0, NA))+
  scale_fill_manual(name="Significant in:",limits= c("Fisher","Fisher & Maximum p-value","Neither"), label=c("Fisher","Fisher & Maximum p-value","Neither"),values=c("#21B0FE","green","grey70"))+
  xlab("Expression Change Agreement (Vote)")+
  ylab("Density")+
...
ggplot(diff_Combined_merge,aes(samples,counts,color=StressOrganism,shape=factor(Tissue,levels =c("Cortical","Hippocampus","Blood","Other")),label=comparison))+
  ...
  scale_color_manual(name="Subject Type",values = StressOrganismColors)+
...
ggsave("Figures/DiffGenesResponseScatter.png",height = 4,width = 4)
...
ggplot(diff_Combined_merge[diff_Combined_merge$TorR=="RN",],aes(samples,counts,color=StressOrganism,shape=factor(Tissue,levels =c("Cortical","Hippocampus","Blood","Other")),label=comparison))+
  ...
  theme_classic()+
  geom_text_repel(max.overlaps = 20,size=3,box.padding   = 0.5, point.padding = 0.5)
ggsave("Figures/DiffGenesResponseScatterLog.png",height = 4,width = 6)

#Treatment
#No scale
ggplot(diff_Combined_merge[diff_Combined_merge$TorR=="TU",],aes(samples,counts,color=StressOrganism,shape=factor(Tissue,levels =c("Cortical","Hippocampus","Blood","Other")),label=comparison))+
  geom_point(size=5,stroke=2)+
  scale_color_manual(name="Subject Type",values = StressOrganismColors)+
  scale_shape_manual(name="Tissue",values = c(1,2,3,0))+  
  xlab("Samples per Group")+
  ylab("Number of Significant Genes")+
  theme_classic()+
  geom_text_repel(max.overlaps = 6,size=3,box.padding   = 0.5, point.padding = 0.5)+
  guides(color=FALSE,shape=FALSE)
ggsave("Figures/DiffGenesTreatmentScatter.png",height = 5,width = 4)
...
#Response
#No scale
ggplot(GSEA_Combined_merge[GSEA_Combined_merge$TorR=="RN",],aes(samples,counts,color=StressOrganism,shape=factor(Tissue,levels =c("Cortical","Hippocampus","Blood","Other")),label=comparison))+
  geom_point(size=5,stroke=2)+
  #scale_y_continuous(transform = "log10")+
  scale_color_manual(name="Subject Type",values = StressOrganismColors)+
  scale_shape_manual(name="Tissue",values = c(1,2,3,0))+
...
ggsave("Figures/DiffPathsResponseScatter.png",height = 4,width = 4)
...
#Treatment
#No scale
ggplot(GSEA_Combined_merge[GSEA_Combined_merge$TorR=="TU",],aes(samples,counts,color=StressOrganism,shape=factor(Tissue,levels =c("Cortical","Hippocampus","Blood","Other")),label=comparison))+
  geom_point(size=5,stroke=2)+
  #scale_y_continuous(transform = "log10")+
  scale_color_manual(name="Subject Type",values = StressOrganismColors)+
  scale_shape_manual(name="Tissue",values = c(1,2,3,0))+  
...
ggsave("Figures/DiffPathsTreatmentScatter.png",height = 5,width = 4)
